...
import torch
from pretrainedmodels import dpn92, se_resnext50_32x4d, se_resnext101_32x4d, senet154
from torch import nn
from torch.utils import model_zoo
# from .densenet import densenet121, densenet169, densenet161
from torchvision.models import densenet121, densenet169, densenet161, resnet

# from . import resnet
# from .dpn import dpn92
# from .senet import se_resnext50_32x4d, se_resnext101_32x4d, SCSEModule, senet154
# from . import pd_densenet, pd_resnet
# import easygold
    ...
    'resnet50':
        {
            ...
            'decoder_filters': [64, 128, 256, 256],
            'last_upsample': 64,
            'init_op': partial(resnet.resnet50),
...
class EncoderDecoder(AbstractModel):
    def __init__(self, num_classes, num_channels=3, encoder_name='resnet34', pretrained=True):
        ...
        encoder = encoder_params[encoder_name]['init_op'](pretrained=pretrained)
...
class SEUnet(EncoderDecoder):
    def __init__(self, seg_classes, backbone_arch='senet154', pretrained='imagenet'):
        self.first_layer_stride_two = True
...
class SCSEUnet(SEUnet):
    def __init__(self, seg_classes, backbone_arch='seresnext50', pretrained=True):
...
if __name__ == '__main__':
    d = DensenetUnet(seg_classes=1, backbone_arch='densenet121') #SCSEUnet(4, backbone_arch='seresnext50', pretrained='imagenet')
    d.eval()
    import numpy as np

    with torch.no_grad():
        images = torch.from_numpy(np.zeros((2, 3, 512, 512), dtype='float32'))
